...
public class MoneyPay extends SubCommand {

    public MoneyPay() {
        super("pay", Config.SERVER_NAME + ".Money.Pay", true);
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if(player.equals(sender)) {
            sender.sendMessage(ColorUtils.translate(LanguageManager.getLanguage().CANNOT_PAY_IT_SELF_MONEY));
            return;
        }
        ...
        senderPlayer.getValueManager().sendMoney(value, target, true);
    }
